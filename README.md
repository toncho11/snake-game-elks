...
* comment out sound functions in code (defined in dos.h), port only delay() for now, a port from [libi86 project](https://github.com/tkchia/libi86/) cof dos.h ould be useful
